...
function checkStep1(str) {
  if (str == 'Hola Mundo!') {
    return showStep(2);
  } else if (str.toLowerCase() == 'hola mundo!') {
    return console.log('Cuidado! Javascript es sensible a las mayusculas y minusculas, trata de escribir el mensaje tal cual');
  }
  console.log('Por favor escribe correctamente el mensaje');
}
